...
pub async fn from_v2_refs_async(in_refs: &mut dyn ReadlineBufRead) -> Result<Vec<Ref>, Error> {
...
pub async fn from_v1_refs_received_as_part_of_handshake_and_capabilities_async<'a>(
